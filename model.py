...
train_data = generate_training_data(Image_train, angle_train, batch_size=bs, validation_flag=False)
valid_data = generate_training_data(Image_train, angle_train, batch_size=bs, validation_flag=True)
test_data = generate_training_data(Image_test, angle_test, batch_size=bs, validation_flag=True)
...
model.fit_generator(train_data, epochs=7, validation_data=valid_data, steps_per_epoch=50, validation_steps=50)
